---
title: "Municipal Indicators For Keene, NH"
output:
  pdf_document:
    toc: yes
    toc_depth: '3'
...
In this report, 40 demographic, educational institutions, employment, healthcare, municipal finance, infrastructure, food insecurity and housing variables are presented using federally-published data sources for the city of Keene, New Hampshire. To better demonstrate their ties to geography of the city, the variables have been mapped on the block group level. \
...
* `r Chelsea.MA$City` has 3 university in 03431 and 03435 ZIP Codes.(https://nces.ed.gov/) 
...
* The largest School District in `r Chelsea.MA$City` contains 290 teachers and 373 other staffs. The total number of teachers in all private schools in `r Chelsea.MA$City` is 75.(http://www.usa.com/)
...
```
* The number of labor force, who are 16 years and older in `r Chelsea.MA$City` is 12636 which is `r round(Chelsea.MA$LabForcePer,2)` of total number of labors (unemployed and not in labor force) of which 12636 are civilian labor forces and `r Chelsea.MA$Military` are armed labor forces.\
...
```
* The median earning in `r Chelsea.MA$City` is 22679 Dollar.\
...
* `r Chelsea.MA$City` has 1 hospital with 110 beds.(https://www.ahd.com/)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$RevenueGeneralFundTotalFY19 <- 44319328
Chelsea.MA$RevenueTaxesFY19 <- 26281654
Chelsea.MA$RevenueLicensesPermitsFeesFY19 <- 3657935
Chelsea.MA$RevenueIntergovernmentalFY19 <- 2707392
Chelsea.MA$RevenueChargesForServicesFY19 <- 1832673
Chelsea.MA$RevenueFinesForfeitsFY19 <- 89821
Chelsea.MA$RevenueMiscellaneousFY19 <- 2573287
Chelsea.MA$RevenueOtherFinancingSourcesFY19 <- 4410566
Chelsea.MA$RevenueProceedsLongTermFinanceFY19 <- 2766000
```
* The total budget revenues for general fund for Keene city is $44,319,328 in fiscal year 2019, which contains the following items: Taxes with 26,281,654 Dollar, licenses/permits/fees with 3,657,935 Dollar, intergovernmental with 2,707,392 Dollar, charges for services with 1,832,673 Dollar, fines and forfeits with 89,821 Dollar, miscellaneous with 2,573,287 Dollar, other financing sources with 4,410,566 Dollar, and proceeds long term fianace with 2,766,000 Dollar.(https://ci.keene.nh.us/sites/default/files/Finance/CityKeeneOpBudgetFinalForWebsite050119.pdf)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$ExpendituresGeneralFundTotalFY19 <- 44319328
Chelsea.MA$ExpendituresAirportFY19 <- 645461
Chelsea.MA$ExpendituresAssessmentFY19 <- 492434
Chelsea.MA$ExpendituresCityAttorneyFY19 <- 354217
Chelsea.MA$ExpendituresCityClerkFY19 <- 607635
Chelsea.MA$ExpendituresCityManagerFY19 <- 453151
Chelsea.MA$ExpendituresFinanceFY19 <- 2367318
Chelsea.MA$ExpendituresFireFY19 <- 6989788
Chelsea.MA$ExpendituresCommunityDevelopmentFY19 <- 1668989
Chelsea.MA$ExpendituresHumanResourcesFY19 <- 375919
Chelsea.MA$ExpendituresInformationTechnologyFY19 <- 1395579
Chelsea.MA$ExpendituresLibraryFY19 <- 1445012
Chelsea.MA$ExpendituresMayorAndCityCouncilFY19 <- 7291707
Chelsea.MA$ExpendituresParksRecAndFacilitiesFY19 <- 3626483
Chelsea.MA$ExpendituresPoliceFY19 <- 7547112
Chelsea.MA$ExpendituresPublicWorksFY19 <- 4524894
Chelsea.MA$ExpendituresDebtServiceFY19 <- 4533629
```

* The total amount of general fund of expenditures for `r Chelsea.MA$City` is $44,319,328 in Fiscal Year 2019 and the major expense driver is related to police department, which is 7,547,112 Dollar. The other expenditures include airport with 645,461 Dollar, assessment with 492,434 Dollar, city attorney with 354,217 Dollar, city clerk with 607,635 Dollar, city manager with 453,151 Dollar, finance with 2,367,318 Dollar, fire with 6,989,788 Dollar, community development with 1,668,989 Dollar, human resources with 375,919 Dollar, information technology with 1,395,579 Dollar, library with 1,445,012 Dollar, mayor and city council with 7,291,707, parks, recreation and facilities with 3,626,483 Dollar, pyblic works with 4,524,894 Dollar, and debt service with 4,533,629 Dollar.(https://ci.keene.nh.us/sites/default/files/Finance/CityKeeneOpBudgetFinalForWebsite050119.pdf)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$RevenueGeneralFundTotalCurrentFY20 <- 41273506
Chelsea.MA$RevenueGeneralFundTotalNoncurrentFY20 <- 4273321
Chelsea.MA$RevenueGeneralFundTotalProposedBudgetFY20 <- 45546827
Chelsea.MA$RevenuePropertyTaxesFY20 <- 25586346
Chelsea.MA$RevenueUseOfSurplusFY20 <- 850000
Chelsea.MA$RevenueOtherTaxesFY20 <- 1897613
Chelsea.MA$RevenueLicensesPermitsFeesFY20 <- 3661664
Chelsea.MA$RevenueIntergovernmentalFY20 <- 3087578
Chelsea.MA$RevenueChargesForServicesFY20 <- 1877110
Chelsea.MA$RevenueFinesForfeitsFY20 <- 63766
Chelsea.MA$RevenueMiscellaneousFY20 <- 1587619
Chelsea.MA$RevenueOtherFinancingSourcesFY20 <- 2661810

Chelsea.MA$ExpendituresGeneralFundTotalFY20 <- 45546827
Chelsea.MA$ExpendituresAirportFY20 <- 677413
Chelsea.MA$ExpendituresCityAttorneyFY20 <- 348802
Chelsea.MA$ExpendituresCityClerkFY20 <- 659817
Chelsea.MA$ExpendituresCityManagerFY20 <- 396706
Chelsea.MA$ExpendituresFireFY20 <- 7388302
Chelsea.MA$ExpendituresCapitalProjectsFY20 <- 6197908
Chelsea.MA$ExpendituresCommunityDevelopmentFY20 <- 1520486
Chelsea.MA$ExpendituresFinanceHumanSvcsFY20 <- 2490517
Chelsea.MA$ExpendituresInformationTechnologyFY20 <- 1380404
Chelsea.MA$ExpendituresLibraryFY20 <- 1554752
Chelsea.MA$ExpendituresParksRecAndFacilitiesFY20 <- 3874164
Chelsea.MA$ExpendituresPoliceFY20 <- 7854747
Chelsea.MA$ExpendituresPublicWorksFY20 <- 4631284
Chelsea.MA$ExpendituresDebtServiceFY20 <- 4358252
Chelsea.MA$ExpendituresEmployeeBenefitsFY20 <- 521457
Chelsea.MA$ExpendituresHumanResourcesFY20 <- 380593
Chelsea.MA$ExpendituresOutsideAgenciesFY20 <- 284780
Chelsea.MA$ExpendituresRiskManagementFY20 <- 260005
Chelsea.MA$ExpendituresMayorAndCityCouncilFY20 <- 157331
Chelsea.MA$ExpendituresUnclassifiedFY20 <- 101961
```

* The total current revenues for general fund for Keene city is $41,273,506 in fiscal year 2020, which contains the following items: Property tax revenue with 25,586,346 Dollar, use of (addition to) surplus with 850,000 Dollar, other taxes with 1,897,613 Dollar, licenses/permits/fees with 3,661,664 Dollar, intergovernmental with 3,087,578 Dollar, charges for services with 1,877,110 Dollar, fines and forfeits with 63,766 Dollar, miscellaneous with 1,587,619 Dollar, and other financing sources with 2,661,810 Dollar. The total noncurrent revenues and total proposed budget for Keene city are 4,273,321 and 45,546,827 Dollar in fiscal year 2020 respectively. 
The total amount of general fund of expenditures for `r Chelsea.MA$City` is $45,546,827 in Fiscal Year 2020 and the major expense driver is related to police department, which is 7,854,747 Dollar. The other expenditures include fire with 7,388,302 Dollar, capital projects with 6,197,908 Dollar, public works with 4,631,284 Dollar, debt service with 4,358,252 Dollar, parks, recreation, facilities and youth services with 3,874,164 Dollar, finance and human services with 2,490,517 Dollar, library with 1,554,752 Dollar, community development with 1,520,486 Dollar, information technology with 1,380,404 Dollar, airport with 677,413 Dollar, assessment with 507,149 Dollar, city attorney office with 348,802 Dollar, city clerk office with 659,817 Dollar, city manager office with 396,706 Dollar, employee benefits with 521,457 Dollar, human resources with 380,593 Dollar, outside agencies with 284,780 Dollar, risk management with 260,005 Dollar, mayor and city council with 157,331 Dollar, and unclassified items with 101,961 Dollar.(https://ci.keene.nh.us/sites/default/files/Finance/20-21%20guide.pdf)
...
* Keene city has an Airport, which is called Keene Dillant-Hopkins Airport (EEN) and it is located in the heart of the Monadnock region of New Hampshire where an abundance of outdoor recreation, skiing and art venues exist. "This region is known for its exceptional quality of life, while having easy access to the major regional cities". In this airport some services are provided such as air freight, jet maintenance, an avionics center or a fly-in boutique hotel. (https://ci.keene.nh.us/)
...
* City Express is Keene’s bus for everyone, which has stops in Keene and Swanzey. All buses are equipped with bike racks and a wheelchair lift. Additionally, Greyhound provides charter bus service from downtown Keene to the Brattleboro, VT Amtrak Station. Moreover, Amtrak Vermonter provides passenger rail service from Washington D.C. to St. Albans Vermont.  Although it does not operate within the region, it stops in Brattleboro, VT, which is a half hour drive from Keene.(http://www.mastnh.org/public-transit-options/)
...
* There are 5 providers in Keene, which can offer home connections, and a total of 17 including specialized smb, enterprise, and mobile providers like Spectrum Business and GTT Communications. The most likely provider for residents in Keene is Viasat Internet, which are accessible for approximately one hundred percent of Keene census blocks. The most likely second option in this city is HughesNet, which is serving about one hundred percent of residents with predominantly Satellite Internet service. "The most prevalent wired broadband Internet connection options are Cable (99.19 percent coverage) and Satellite in Keene. TV corporations are usually the source for cable Internet, because they can use their existing TV wires — which already connect to most homes — to connect customers to the Internet. The average amount of market competition is 1.98 service providers per census block. Unfortunately, this low level of competition leaves 5.76% of residents with only one option, or no coverage at all". There are 13 internet providers in Keene with 5 of those offering residential service. Therefore, Keene is the 98th most connected city in New Hampshire and the fastest zip code in Keene for May 2020 is 03431.(https://broadbandnow.com/New-Hampshire/Keene)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$NumGrocery <- 24
```
* `r Chelsea.MA$City` has 24 Grocery Stores. (https://www.city-data.com/city/Keene-New-Hampshire.html)
...
```
* The median house value in `r Chelsea.MA$City` is 187900 Dollar.\

* The average house value in `r Chelsea.MA$City` is 1017312400 Dollar.\
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$PropertyTaxRate <- 14.81
```
* The 2019 tax rate is 14.81 Dollar per 1000.00 Dollar of assessed valuation in `r Chelsea.MA$City`.(https://ci.keene.nh.us/assessing/tax-rate-information)
...
tm_shape(chelsea.dur) + tm_polygons(c("MedYrMovedIn_BG","MedYrRentMovedIn_BG","MedYrOwnMovedIn_BG"), style="jenks", palette=list("Greens","seq","Blues"), border.col = "darkgray", title=c("MedYrMovedIn","MedYrRentMovedIn","MedYrOwnMovedIn")) + tm_view(alpha = 0.85, basemaps = "Stamen.TonerLite") + tm_layout(legend.position = c("left","top"))
```
...
* City of Keene Human Services Department offer following services for residents in Keene: Rent, Electric Disconnect, Prescription - This office must have the actual Prescription, and Heat (Winter Season). Also, they offer help paying rent along with providing housing assistance through 6 organizations, which are Cheshire Housing Trust, EJL Management, Keene Housing, New Hampshire Housing Finance Authority, Southwestern Community Services, and Stewart Property Management.(https://ci.keene.nh.us/human-services/housing-assistance)
