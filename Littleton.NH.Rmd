---
title: "Municipal Indicators For Littleton, NH"
output:
  pdf_document:
    toc: yes
    toc_depth: '3'
...
In this report, 39 demographic, educational institutions, employment, healthcare, municipal finance, infrastructure, food insecurity and housing variables are presented using federally-published data sources for the city of Littleton, New Hampshire. To better demonstrate their ties to geography of the city, the variables have been mapped on the block group level. \
...
ch.pop <- read_acs5year(year = endyr,
				 ...
				 rename(TotalPop = population,
				        City = area) %>% select(City, TotalPop)
...
```
* The median household income in the past 12 months is 40125 Dollar in `r Chelsea.MA$City`.\
...
* `r Chelsea.MA$City` has 9 public school district, which contains 1582 students and 5 public schools. Also, `r  Chelsea.MA$City` has no private schools.(https://nces.ed.gov/) 

\


```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$SchoolsDistrict <- 9
Chelsea.MA$SchoolsDistStudents <- 1582
Chelsea.MA$PubSchools <- 5
...
* `r Chelsea.MA$City` has no university in 03561 ZIP Code.(https://nces.ed.gov/) 
...
* The major School District in `r Chelsea.MA$City` contains 81 teachers and 90 other staffs.(http://www.usa.com/)
...
tm_shape(chelsea.job) + tm_polygons("NumJobs", style="pretty", palette="Reds", border.col = "darkgray", title="Number of Jobs") + tm_view(alpha = 0.85,view.legend.position = c("right", "bottom"), basemaps = "Stamen.TonerLite")
```
...
```
* The number of labor force, who are 16 years and older in `r Chelsea.MA$City` is 3388 which is `r round(Chelsea.MA$LabForcePer,2)` of total number of labors (unemployed and not in labor force) of which 3388 are civilian labor forces and `r Chelsea.MA$Military` are armed labor forces.\
...
tm_shape(chelsea.majorEmp) + tm_polygons(c("MaleNCAIS_BG","FemaleNCAIS_BG"), style="pretty", palette=list("Greens","seq"), border.col = "darkgray", title=c("MaleNCAIS","FemaleNCAIS")) + tm_view(alpha = 0.85, basemaps = "Stamen.TonerLite") + tm_layout(legend.position = c("left","bottom"))
...
```
* The median earning in `r Chelsea.MA$City` is 28729 Dollar.\
...
MA.Emp.Age.ch2 <- read_acs5year(year = endyr,
                     states = j,
                     table_contents = c("B23001_003", "B23001_010","B23001_017","B23001_024", # Age 29 or younger male
								"B23001_031","B23001_038","B23001_045", # Age 30 to 54 male
								"B23001_052", "B23001_052","B23001_066","B23001_073","B23001_078", "B23001_083",# Age 55 or older male
								
								
								"B23001_089","B23001_096","B23001_103","B23001_110", # Age 29 or younger female
								"B23001_117","B23001_124","B23001_131", # Age 30 to 54 female
								"B23001_138","B23001_145", "B23001_152", "B23001_159", "B23001_164", # Age 55 or older female
														              "B23001_001"),
                     areas = area,
                     summary_level = "tract") %>%
  rename(City = area) %>%
...
MA.Emp.Sex.ch2 <- read_acs5year(year = 2018,
                     states = "NH",
                     table_contents = c("B23001_005", # Employed males
														              "B23001_007", 
														              "B23001_012",
														              ...
														              "B23001_171",
														              "B23001_001",
														              "B23001_008","B23001_009","B23001_015","B23001_016","B23001_022", "B23001_023","B23001_029", "B23001_030","B23001_036","B23001_037","B23001_043","B23001_044","B23001_050","B23001_051","B23001_057","B23001_058",	"B23001_064","B23001_065","B23001_071","B23001_072","B23001_076","B23001_077","B23001_081","B23001_082","B23001_086","B23001_087","B23001_094","B23001_095","B23001_101","B23001_102","B23001_108","B23001_109","B23001_115","B23001_116","B23001_122","B23001_123","B23001_129","B23001_130","B23001_136","B23001_137","B23001_143","B23001_144","B23001_150","B23001_151","B23001_157","B23001_158","B23001_162","B23001_163","B23001_167","B23001_168","B23001_172","B23001_173"),
                     areas = "Manchester, NH",
                     summary_level = "Place") %>%
  rename(City = area) %>%
  	mutate(EmpMale = B23001_005 + B23001_007 + B23001_012 + B23001_014 + B23001_019 + B23001_021 + B23001_026 + B23001_028 + B23001_033 + B23001_035 + B23001_040 + B23001_042 + B23001_047 + B23001_049 + B23001_054 + B23001_056 + B23001_061 + B23001_063 + B23001_068+ B23001_070 + B23001_075 + B23001_080 + B23001_085+ B23001_008 + B23001_009 + B23001_015 + B23001_016 + B23001_022 + B23001_023+B23001_029 + B23001_030 + B23001_036 + B23001_037 + B23001_043 + B23001_044 + B23001_050 + B23001_051 + B23001_057 + B23001_058 + 	B23001_064 + 	B23001_065 + 	B23001_071 + 	B23001_072 + 	B23001_076 + 	B23001_077 + 	B23001_081 + 	B23001_082 + 	B23001_086 + 	B23001_087,
  	       
  	       
	  EmpFemale = B23001_091 + B23001_093 + B23001_098 + B23001_100 + B23001_105 + B23001_107 + B23001_112 + B23001_114 + B23001_119 + B23001_121 + B23001_126+ B23001_128 + B23001_133 + B23001_135 + B23001_140 + B23001_142 + B23001_147 + B23001_149 + B23001_154 + B23001_156 + B23001_161 + B23001_166 + B23001_171 + 	B23001_094 + 	B23001_095 + 	B23001_101 + 	B23001_102 + 	B23001_108 + 	B23001_109 + 	B23001_115 + 	B23001_116 + 	B23001_122+ 	B23001_123 + 	B23001_129 + 	B23001_130 + 	B23001_136 + 	B23001_137 + 	B23001_143 + 	B23001_144 + 	B23001_150 + 	B23001_151 + 	B23001_157 + 	B23001_158 + 	B23001_162 + 	B23001_163 + 	B23001_167 + 	B23001_168 + 	B23001_172 + 	B23001_173,
	  TotalEmp = EmpMale + EmpFemale,
	  EmpMalePer = EmpMale/	B23001_001,
	  EmpFemalePer = EmpFemale/B23001_001) %>%
	select(City, EmpMale, EmpFemale, TotalEmp, EmpMalePer, EmpFemalePer) %>%
...
Chelsea.MA <- cbind(MA.Emp.Sex.ch2)
```
...
* `r Chelsea.MA$City` has 1 nursing homes in Littleton and 9 nearby. (https://www.senioradvice.com/nursing-homes/littleton-nh)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$RevenueGeneralFundTotalFY17 <- 22094694
Chelsea.MA$RevenueTaxesFY17 <- 17859027 
Chelsea.MA$RevenueNonRevenueReceiptsFY17 <- 2265650 
Chelsea.MA$RevenueLicensesAndPermitsFY17 <- 1254752 
Chelsea.MA$RevenuesFromOtherGovernmentsFY17 <- 488210 
Chelsea.MA$RevenueMiscellaneousFY17 <- 148976 
Chelsea.MA$RevenueChargesAndFeesFY17 <- 65653 
Chelsea.MA$RevenueUseOfMoneyAndPropertyFY17 <- 12426 
```
* The total budget revenues for general fund for Littleton city is $22,094,694 in fiscal year 2017, which contains the following items: Taxes with 17,859,027 Dollar, non-revenue receipts with 2,265,650 Dollar, licenses and permits with 1,254,752 Dollar, revenues from other governments with 488,210 Dollar, miscellaneous with 148,976 Dollar, charges and fees with 65,653 Dollar, and use of money and property with 12,426 Dollar.(https://www.cleargov.com/new-hampshire/grafton/town/littleton/2017/expenditures?breakdowntype=department&objectid=862244)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$ExpendituresGeneralFundTotalFY17 <- 21889125
Chelsea.MA$ExpendituresEducationFY17 <- 10704500 
Chelsea.MA$ExpendituresNonDepartmentalFY17 <- 4121577 
Chelsea.MA$ExpendituresPublicSafetyFY17 <- 2999040 
Chelsea.MA$ExpendituresGeneralGovernmentFY17 <- 1438797 
Chelsea.MA$ExpendituresTransportationFY17 <- 1212476 
Chelsea.MA$ExpendituresPhysicalEnvironmentFY17 <- 781747 
Chelsea.MA$ExpendituresCultureAndRecreationFY17 <- 339826 
Chelsea.MA$ExpendituresHumanServicesFY17 <- 158383
Chelsea.MA$ExpendituresOtherPublicWorksFY17 <- 92500
Chelsea.MA$ExpendituresEconomicEnvironmentFY17 <- 40279
```

* The total amount of general fund of expenditures for `r Chelsea.MA$City` is $21,889,125 in Fiscal Year 2017 and the major expense driver is related to education, which is 10,704,500 Dollar. The other expenditures include non departmental with 4,121,577 Dollar, public safety with 2,999,040 Dollar, general government with 1,438,797 Dollar, transportation with 1,212,476 Dollar, physical environment with 781,747 Dollar, culture and recreation with 339,826 Dollar, human services with 158,383 Dollar, other public works with 92,500 Dollar, and economic environment with 40,279 Dollar.(https://www.cleargov.com/new-hampshire/grafton/town/littleton/2017/expenditures?breakdowntype=department&objectid=862244)
...
* Littleton city in New Hampshire is located in the White Mountains near the Vermont border. Littleton is a center for business, shopping, medical care, education and services in New Hampshire’s North Country. The center of Littleton is accessible from three exits of Interstate 93, and a fourth exit serves the western end of town near the Vermont border. U.S. Route 302 runs east–west through the town center as its Main Street. (http://www.townoflittleton.org/). The nearest major airport is Lebanon Municipal Airport (LEB / KLEB), which has domestic flights from West Lebanon, New Hampshire and is 83 miles from the center of Littleton, NH.
...
* As of January 2006 Littleton is served by a public transportation bus route connecting with Whitefield and Lancaster.(https://en.wikipedia.org/wiki/Littleton,_New_Hampshire)
...
* The most common wired broadband varieties in Littleton, NH are Cable and Satellite, which have 98.00 percent and close to one hundred percent coverage respectively. The main Internet choices in this city are Viasat Internet and HughesNet. The average Littleton census block has 3 providers to choose from. There are 11 internet providers in Littleton with 6 of those offering residential service. Littleton is the 79th most connected city in New Hampshire and the fastest zip code in Littleton for May 2020 is 03561. (https://broadbandnow.com/New-Hampshire/Littleton)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$NumGrocery <- 4
```
* `r Chelsea.MA$City` has 4 Grocery Stores. (https://www.yellowpages.com/)
...
```
* The median house value in `r Chelsea.MA$City` is 162700 Dollar.\

* The average house value in `r Chelsea.MA$City` is 254510700 Dollar.\
...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide', comment=""}
Chelsea.MA$PropertyTaxRate <- 23.10
```
* The 2019 tax rate is 23.10 Dollar per 1000 Dollar of assessed valuation in `r Chelsea.MA$City`.(https://joeshimkus.com/NH-Tax-Rates-2019.aspx)
...
* There are two rental assistance program in Littleton city, which are Community Action Program - Littleton and Ahead. Community Action Program "provides energy assistance programs (heating fuel and electricity), a food pantry, and Information and Referral Services to help consumers find appropriate help. Community Action is a community outreach agency addressing the needs of North Country residents with limited incomes". AHEAD is a non-profit housing agency that provides:  Property development, Rental housing, Home ownership, and Educational services.(https://www.rentassistance.us/ci/nh-littleton)



```{r}
Littleton <- Chelsea.MA
Littleton
```
